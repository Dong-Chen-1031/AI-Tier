...
export const TierInputGroup = ({
    ...
    const tierList = getTierList(i18n.language);
    const styleKeys = [
        "default",
        "sarcastic",
        "generous",
    ...
    const getStyleValue = (key: string) => t(`form.styles.${key}`);
                ...
                {progress === "setting" || progress === "loading" ? (
                    <motion.div
                        ...
                        <form
                            ...
                            <InputGroup>
                                <InputGroupInput
                                    placeholder={t("form.reviewerDescription")}
                            ...
                            <InputGroup>
                                <InputGroupInput
                                    placeholder={t("form.suggestions")}
                                    {...register("suggestion")}
                                />
                                <InputGroupAddon>
                                    <MessageCircleQuestionMarkIcon />
            ...
            {progress === "finished" ? (
                <>
                    ...
                    <div className="flex h-full w-full items-center justify-center flex-col gap-6">
                        {!hasMoved && (
                            <EnterAnimation imgUrl={imgUrl} layoutId={imgUrl} />
                        )}
